...
namespace CH03
{
    internal class _5_Array
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("ass2d[0,0] : " + arr2d[0,0]);
            Console.WriteLine("ass2d[0,2] : " + arr2d[0,2]);
            Console.WriteLine("ass2d[1,2] : " + arr2d[1,2]);
            Console.WriteLine("ass2d[2,3] : " + arr2d[2,3]);
            ...
            // 3,5,11,17,25 출력
            Console.WriteLine("3출력 : " + arr3d[0, 0, 2]);
            Console.WriteLine("5출력 : " + arr3d[0, 1, 1]);
            Console.WriteLine("11출력 : " + arr3d[1, 0, 1]);
            Console.WriteLine("17출력 : " + arr3d[1, 2, 1]);
            Console.WriteLine("25출력 : " + arr3d[2, 2, 0]);
