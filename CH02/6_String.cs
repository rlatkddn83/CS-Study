...
namespace CH02
{
    internal class _6_String
    {
        static void Main(string[] args)
        {
            ...
            //문자열 길이
            Console.WriteLine("greeeting길이 : "+greeting.Length);
            Console.WriteLine();

            //문자열 추출
            Console.WriteLine("greeeting[0] : " + greeting[0]);
            Console.WriteLine("greeeting[3] : " + greeting[3]);
            Console.WriteLine("greeeting[5] : " + greeting[5]);
            Console.WriteLine();
