...
namespace CH02
{
    internal class _2_DataType
    {
        ...
        {
            // 정수형
            sbyte num1 = 127; //1byte 부호있는 정수 -128~127
            byte  num2 = 255; //1byte 부호없는 정수 0~255
            short num3 = -32768; //2byte 부호있는 정수 -32768~32767
            int   num4 = -2147483648; //4byte 부호있는 정수 -2147483648~2147483647
            long  num5 = 2147483648; //8byte 교재참조
