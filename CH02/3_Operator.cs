...
namespace CH02
{
    internal class _3_Operator
    {
        static void Main3(string[] args)
        {
            ...
            bool res1 = val1 > 1 && val2 > 2; //val1이 1보다 크다 그리고 val2는 2보다 크다.
            bool res2 = val1 > 0 && val2 > 1; //val1이 0보다 크다 그리고 val2는 1보다 크다.
            bool res3 = val1 > 1 || val2 > 2; //val1이 1보다 크다 또는 val2는 2보다 크다.
            bool res4 = val1 > 0 || val2 > 2; //val1이 0보다 크다 또는 val2는 2보다 크다.
            bool res5 = !(val1 >  val2); //val1이 val2보다 크지 않다.
            ...
            string result = (a > 1) ? "a는 1보다 크다.": "a는 1보다 크지않다.";
